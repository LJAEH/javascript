...
function fnTest2() {
    // 요소 여러개를 한번에 접근하는 경우 배열 형태로 반환임
...
function fnTest3(){
    // 문서내에 존재하는 모든 li 요소를 얻어와 배열 형식으로 전환
...
function fnTest5() {
    // name 속성값이 hobby 인 요소를 모두 얻어와 배열 형식으로 변환
